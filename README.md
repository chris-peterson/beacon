...
Requirements (EARS) and architecture in [DESIGN.md](DESIGN.md). beacon ships as three deliverables:

| ID | What | Form |
|:---|:---|:---|
| D1 | This specification | `DESIGN.md` |
